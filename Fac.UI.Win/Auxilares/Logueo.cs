...
namespace Fac.UI.Win
{
    public static class Logueo
    {
        ...
        public static string DomicilioFiscalCodigo = "0000";
        public static string DomicilioFiscalDescripcion = "DOMICILIO FISCAL";

        public static string[] rowselectedbyuser = new string[1000];
        public static int countofrowsselectedbyuser = 0;
        public static string periodo = "202110";
        ...
        public static string GetPathServerrReportSSRS()
        {
            ...
            //return "http://SERVIDOR1:8080/ReportServer"; // URL de reportes
            return "http://servidor:8081/Reports_SQL2008"; // URL de servicio de reportes.                                                
        }
