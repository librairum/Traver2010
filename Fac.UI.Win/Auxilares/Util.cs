...
namespace Fac.UI.Win
{
   ...
   static void activaBoton(RadCommandBarBaseItem boton, bool valor)
    ...
    public static string NumberFormat(string valor, string formato = "{0:#,##0.00}")
    {
        ...
        string Formateado = string.Format(formato, numero);
        return Formateado;
    }
    ...
    public static void habilitarBotonProdDet(string nombre, GridCommandCellElement CommandCell, bool bGrabar,
                                        bool bCancelar, bool bEliminar, bool bEditar, bool bVerDetalle = false)
    {
    ...
    public static void deshabilitarBotonDetalle(BaseRegBotonesDetalle boton, GridCommandCellElement commandCell)
    {
        switch (boton)
        {
            case BaseRegBotonesDetalle.btnEditarDet:
                commandCell.CommandButton.Image = Properties.Resources.edited_disabled;
                break;
            case BaseRegBotonesDetalle.btnEliminarDet:
                commandCell.CommandButton.Image = Properties.Resources.delete_disabled;
                break;
            case BaseRegBotonesDetalle.btnGuardarDet:
                commandCell.CommandButton.Image = Properties.Resources.save_disabled;
                break;
            case BaseRegBotonesDetalle.btnCancelarDet:
                commandCell.CommandButton.Image = Properties.Resources.cancel_disabled;
                break;
            default: break;
        }
    ...
    public static void habilitarBotonDetalle(BaseRegBotonesDetalle boton, GridCommandCellElement commandCell)
    {
        switch (boton)
        {
            case BaseRegBotonesDetalle.btnEliminarDet:
                if (commandCell.ColumnInfo.Name == "btnEliminarDet")
                {
                    commandCell.CommandButton.Image = Properties.Resources.delete_enabled;
                }
                break;

            case BaseRegBotonesDetalle.btnEditarDet:
                if (commandCell.ColumnInfo.Name == "btnEditarDet")
                {
                    commandCell.CommandButton.Image = Properties.Resources.edit_enabled;
                }
                break;
            case BaseRegBotonesDetalle.btnGuardarDet:
                if (commandCell.ColumnInfo.Name == "btnGrabarDet")
                {
                    commandCell.CommandButton.Image = Properties.Resources.save_enabled;
                }

                break;
            case BaseRegBotonesDetalle.btnCancelarDet:
                if (commandCell.ColumnInfo.Name == "btnCancelarDet")
                {
                    commandCell.CommandButton.Image = Properties.Resources.cancel_enabled;
                }
