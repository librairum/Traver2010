...
namespace Prod.UI.Win
{
    public partial class FormViewCristal : Form
    {
        ...
        private void FormViewCristal_Load(object sender, EventArgs e)
        {
            ...
            //var datos = DocumentoLogic.Instance.RptKardexDet(Logueo.CodigoEmpresa, Logueo.Anio, "03", "04", "04", "P",
            //                                        "");
            //Prod.UI.Win.Reportes.RptPrueba reporte = new Prod.UI.Win.Reportes.RptPrueba();
            //reporte.SetDataSource(datos);
            //this.crv.ReportSource = reporte;
        }
