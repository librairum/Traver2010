...
namespace TutUpdate.UI
{
    public partial class frmActualizacion : Form
    {
        ...
        private string _flagEjecucion = "", _cadenaConexion = "",
                        ...
                        _RutaDondeEstaInstaladoElPrograma = "",
        ...
        public frmActualizacion(string parametros)
        {
            ...
            //parametros = @"Local|Data§Source=(local);Initial§catalog=MasterPla;Integrated§Security=false;§user§id=sa;§password=sasasa;|MasterPla|MasterPla|Masterpla.exe|ContabilidadNet.exe.config|1|C:\Program§Files§(x86)\MasterCon\MasterCon|SI|ArchivosParaActualizacion|Actualizacion.sql|Debug.zip";            
            ...
            this._RutaDondeEstaInstaladoElPrograma = datos[7].Replace('§', ' ');
        ...
        private bool ActualizarArchivos()
        {
            ...
            try
            {
                ...
                {
                    rutaDestino = _RutaDondeEstaInstaladoElPrograma;
                }
                else
                {
        ...
        private bool EjecutarSQL(string comando)
        {
            ...
            //try
            //    {
            //using (var command = new SqlCommand(comando, cn))
            //{
